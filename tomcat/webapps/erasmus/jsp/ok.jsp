...
<div id="global">
    ...
    <div id="cadre1">
        <table>
   <tr>
       <td><button style="background-color: #435BD4;height: 220px;width:270px " type="button" class="btn btn-lg btn-primary" onclick="self.location.href='search_student.jsp?search=all'" >Search a student </button></td>
